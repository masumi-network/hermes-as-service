...
// Images section — extracted verbatim to images-routes.ts (pure move).
router.route('/', imagesAdminRouter);
...
// Tests section — extracted verbatim to tests-routes.ts (pure move).
router.route('/', testsAdminRouter);
